...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Users/Patten/Desktop/pollina/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Users/Patten/Desktop/pollina/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'pollina', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager513271d78b1a2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager513271d78b1a2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/Users/Patten/Desktop/pollina/app/cache/dev/jms_diextra/doctrine/EntityManager_513271d78b1a2.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_3a39844a3c77598c9156cc9c7b0c84e5');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_3a39844a3c77598c9156cc9c7b0c84e5');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_3a39844a3c77598c9156cc9c7b0c84e5');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Users\\Patten\\Desktop\\pollina\\src\\pollina\\Bundle\\pollinaBundle\\Entity')), 'pollina\\Bundle\\pollinaBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('pollinapollinaBundle' => 'pollina\\Bundle\\pollinaBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/Users/Patten/Desktop/pollina/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager513271d78b1a2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Users/Patten/Desktop/pollina/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '72b1ba299a8d1579be37764068b835e6c545a039');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/Users/Patten/Desktop/pollina/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Users/Patten/Desktop/pollina/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'pollinapollina.article_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return pollina\Bundle\pollinaBundle\Manager\ArticleManager A pollina\Bundle\pollinaBundle\Manager\ArticleManager instance.
     */
    protected function getPollinapollina_ArticleManagerService()
    {
        return $this->services['pollinapollina.article_manager'] = new \pollina\Bundle\pollinaBundle\Manager\ArticleManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'pollinapollina.aside_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return pollina\Bundle\pollinaBundle\Manager\AsideManager A pollina\Bundle\pollinaBundle\Manager\AsideManager instance.
     */
    protected function getPollinapollina_AsideManagerService()
    {
        return $this->services['pollinapollina.aside_manager'] = new \pollina\Bundle\pollinaBundle\Manager\AsideManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Users/Patten/Desktop/pollina/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Users/Patten/Desktop/pollina/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '/demo/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/demo/secured/logout'));
        $j->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($i, array('login_path' => '/demo/secured/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $k->setProviderKey('secured_area');

        $l = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $i, '/demo/secured/login', false);

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $a, $c), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'secured_area', $k, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $i, array('login_path' => '/demo/secured/login', 'failure_path' => NULL, 'failure_forward' => false), $a), array('check_path' => '/demo/secured/login_check', 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $f, 'secured_area', $l, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '513271d73c976', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f, $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $i, 'secured_area', $l, NULL, NULL, $a));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Users/Patten/Desktop/pollina/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Users/Patten/Desktop/pollina/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Users/Patten/Desktop/pollina/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Users/Patten/Desktop/pollina/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Users\\Patten\\Desktop\\pollina\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
     ...
     *
     * @return EntityManager513271d78b1a2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Users/Patten/Desktop/pollina/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Users/Patten/Desktop/pollina/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('C:/Users/Patten/Desktop/pollina/app/cache/dev/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('C:/Users/Patten/Desktop/pollina/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Users/Patten/Desktop/pollina/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Users/Patten/Desktop/pollina/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev',
            'kernel.logs_dir' => 'C:/Users/Patten/Desktop/pollina/app/logs',
            'kernel.bundles' => array(
                ...
                'pollinapollinaBundle' => 'pollina\\Bundle\\pollinaBundle\\pollinapollinaBundle',
            ...
            'locale' => 'en',
            'secret' => '72b1ba299a8d1579be37764068b835e6c545a039',
            'database_path' => NULL,
            ...
            'debug.container.dump' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '72b1ba299a8d1579be37764068b835e6c545a039',
            ...
            'session.save_path' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Users\\Patten\\Desktop\\pollina\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/Users/Patten/Desktop/pollina/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Users/Patten/Desktop/pollina/app/../web',
            'assetic.write_to' => 'C:/Users/Patten/Desktop/pollina/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/jms_diextra/doctrine/EntityManager_513271d78b1a2.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager513271d78b1a2_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'C:/Users/Patten/Desktop/pollina/app/cache/dev/jms_security',
            ...
            'pollinapollina.aside_manager.class' => 'pollina\\Bundle\\pollinaBundle\\Manager\\AsideManager',
            'pollinapollina.article_manager.class' => 'pollina\\Bundle\\pollinaBundle\\Manager\\ArticleManager',
